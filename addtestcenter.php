	...
	<div class="container-fluid">
		...
		<div class="col-sm-2">
			<ul id="sidebar" class="nav nav-stacked nav-pills" style="color: #660000">
				<li><a href="./TestingCenter" class="active">Go Back</a></li>
			</ul>
		</div>
			<div class="col-sm-5">
					<!-- CONTENT -->
...
if($bool){
  $insert = mysql_query("INSERT INTO `TestCenters` (`id`, `TctrCode`, `tctr_tag`, `LVM_tag`, `cluster`, `Reg_tag`, `BLDG`, `Bldg_desc`, `Room`, `Cap`, `active`, `Remarks`, `N_E`, `Min_P`, `Max_P`, `Total_N`, `tag`)
  									VALUES ('$id','$TctrCode','$tctr_tag', '$LVM_tag', '$cluster', '$Reg_tag','$BLDG','$Bldg_desc','$Room','$Cap', '$active', '$Remarks', '$N_E', '$Min_P', '$Max_P', '$Total_N', '$tag');");
