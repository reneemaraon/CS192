...
<!-- baba -->
	<div class="container-fluid">
		<div class="row" >
			...
			<div class="col-sm-9">
						<!-- CONTENT -->
						<h3 class="specialcolor"> Assigning Personnel No. <?php echo $_SESSION["assignp"];?> to Room </h3>
						<br>
						<form class="form-inline" action="filterassign.php" method="POST">
							...
							<table class="table">
								...
								$sql = "SELECT * FROM `testcenters` WHERE tctr_tag='DIL'";
								if ($_POST["BLDG"]!=""){
									$sql = $sql." AND Bldg_desc='".$_POST["BLDG"]."'";
								}
								$result = $conn->query($sql);
