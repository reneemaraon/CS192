...
<form class="form-group row" action='' method="POST">
	<fieldset>
		...
		<div class="control-group">
			<!-- Password-->
			<label class="control-label" for="password">Rights</label>
			<div class="controls">
				<input type="password" id="rights" name="rights" placeholder="" class="input-xlarge">
				<p class="help-block">1 for Admin, 2 for Itinerary, 3 for Assignments</p>
			</div>
		</div>
...
if($bool){
	mysql_query("INSERT INTO user (name, username, password, email, phone, rights) VALUES ('$name', '$username', '$encpass', '$email', '$phone', '$rights')");
