	...
	<div class="container-fluid">
		<div class="row" >
			...
			<div class="col-sm-10">
						...
						<br>
						<a href="../pdf.php">Generate Invited List</a>
						<br>
						...
						<br>
						<a href="../homewarning.php">Check Warning</a>
		<div id="wrap">   
			<!-- Feedback message zone -->
			<div id="message"></div>

						<div id="toolbar">
							<input type="text" id="filter1" name="filter" placeholder="UPCAT Year"  />
							<input type="text" id="filter2" name="filter" placeholder="Name"  />
							<input type="text" id="filter3" name="filter" placeholder="UCode"  />
							<input type="text" id="filter4" name="filter" placeholder="Assignment"  />
		...
		<script type="text/javascript">
			...
			window.onload = function() { 
								...
								$("#filter4").keyup(function() {
										datagrid.editableGrid.filter( $(this).val(),[7]);
