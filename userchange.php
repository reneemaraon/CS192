		...
		<div class="row" >
			...
			<div class="col-sm-9">
					...
					<?php
								...
								echo '<a href="userchange2.php?id='.$pid.'&des=1">Admin</a></td><br>';
								echo '<a href="userchange2.php?id='.$pid.'&des=2">Assignment</a></td><br>';
								echo '<a href="userchange2.php?id='.$pid.'&des=3">Itinerary</a></td><br>';
								echo "<br>";
