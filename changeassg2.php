...
<!-- baba -->
	<div class="container-fluid">
		<div class="row" >
			...
			<div class="col-sm-9">
						<!-- CONTENT -->
						<h3 class="specialcolor"> Inviting <?php echo $_GET["id"];$pid=$_GET["id"]; $_SESSION["assignp"]= $pid;
						echo $_GET["des"]; $pdes=$_GET["des"]; $_SESSION["assignp2"] = $pdes;
						?>  </h3>
					...
					<?php
								...
								echo $pdes;
								$sql = "UPDATE Invites SET ASSG = '$pdes' WHERE id=$pid;";	
